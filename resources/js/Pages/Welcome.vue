		...
		<div v-if="canRegister" class="container">
			<div class="row">
				<div class="col-12 text-center mt-3 mb-3">
					<button type="button" class="btn btn-success text-white" @click="showModal">CONTINUE TO REGISTRATION</button>
				</div>
			</div>
			...
			>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-danger text-white" data-dismiss="modal" @click="closeModal">Close</button>
					<Link 
						:href="route('register')"
						as="button"
						id="registerBtn" 
